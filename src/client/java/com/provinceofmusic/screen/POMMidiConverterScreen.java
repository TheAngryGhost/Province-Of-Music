...
import com.provinceofmusic.ConvertToMidi;
import com.provinceofmusic.ReplayMusic;
...
public class POMMidiConverterScreen extends Screen {

    Screen doneScreenInstance;
    File fileInstance;
    protected POMMidiConverterScreen(Text title, Screen doneScreenInstance, File fileInstance) {
        super(title);
